defmodule InvoiceAppWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule InvoiceAppWeb.PageLive do
        use InvoiceAppWeb, :live_view

        on_mount {InvoiceAppWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{InvoiceAppWeb.UserAuth, :ensure_authenticated}] do
